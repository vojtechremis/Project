...
class PCA:
    ...
    def missingNumbers(self, X : np.array) -> bool:
        return np.any(X == None) or np.isnan(X).any()
    ...
    def getPrincipalEigenvectors(self, scaled : bool):
        ...
        if self.eigenvectors is not None:
            ...
            print('PCA analysis haven\'t been performed yet. Use method fit, to initialize the method.')
    ...
    def save(self, outputDir : str):
        ...
        try:
            ...
            print(f'PCA basic data have been saved to \'{outputDir}\'.')

        except Exception as e:
            print(f'Error when saving PCA basic data. Error: {e}')
    ...
    def load(self, sourceDir : str):
        ...
        try:
            ...
            print(f'Error when loading PCA basic data. Error: {e}.')
